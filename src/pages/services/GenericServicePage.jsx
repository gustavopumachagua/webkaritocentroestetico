  ...
  return (
    <article className="surface-panel rounded-[2rem] p-8 sm:p-10">
      ...
      <BulletList
        items={items}
        className="mt-6"
        bulletClassName={accent ? "bg-[var(--color-gold)]" : ""}
      />
    </article>
  );
}
...
export default function GenericServicePage({ service }) {
  ...
  const relatedServices = getRelatedServicesForService(service.id);
    ...
    <SiteLayout>
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-white/8 bg-[#091019] p-3 shadow-[0_24px_70px_rgba(0,0,0,0.28)]">
                <OptimizedImage
                  ...
                  wrapperClassName="aspect-[4/5] w-full rounded-[1.5rem]"
      ...
      <SectionShell tone="warm">
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
          ...
          <div className="space-y-6">
            {content.usesItems?.length ? (
              <div className="surface-panel rounded-[2rem] p-8 sm:p-10">
                <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[var(--color-gold)]">
                  {content.usesTitle}
                </p>
                <BulletList
                  items={content.usesItems}
                  className="mt-6"
                  bulletClassName="bg-[var(--color-gold)]"
                />
              </div>
            ...
            <div className="surface-panel rounded-[2rem] p-8 sm:p-10">
              ...
              <h2 className="mt-4 text-[2rem] font-medium text-[var(--color-ink)] sm:text-[2.4rem]">
