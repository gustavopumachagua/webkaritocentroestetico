...
function BodyParagraph({ html, index }) {
  ...
  return (
    <div
      className="desc-para group relative pl-5"
      ...
      <span
        className={`absolute left-0 top-1 h-full w-[2px] rounded-full transition-all duration-500 ${
          isFirst
            ...
            : "bg-[rgba(160,94,76,0.18)] group-hover:bg-[rgba(160,94,76,0.45)]"
        }`}
      />
      <p
...
export default function DeepCleanseDescriptionSection() {
  const { descriptionSection } = deepCleansePage;
  ...
  return (
    <section className="relative overflow-hidden border-y border-white/5 bg-gradient-to-b from-[#081019] via-[#0d141d] to-[#081019] py-20 sm:py-28 lg:py-36">
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div
          className="absolute -left-24 top-8 h-[340px] w-[340px] rounded-full opacity-60"
          style={{
            background:
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle, #553126 1px, transparent 1px)",
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-4xl">
          <div className="desc-header-entrance flex flex-col items-center gap-4">
            <h2 className="text-center text-3xl font-medium leading-tight tracking-tight text-[var(--color-ink)] sm:text-4xl lg:text-5xl">
          ...
          <div className="surface-panel desc-card-entrance relative mt-14 overflow-hidden rounded-[2rem] px-6 py-10 shadow-[0_18px_52px_rgba(0,0,0,0.24),0_24px_72px_rgba(0,0,0,0.16)] backdrop-blur-xl sm:px-10 sm:py-12 lg:px-14 lg:py-14">
            <div
              aria-hidden
      ...
      <style>{`
        ...
        @keyframes descParaIn {
          from { opacity: 0; transform: translateX(-10px); }
          to   { opacity: 1; transform: translateX(0); }
        }
        .desc-header-entrance { animation: descFadeDown 0.6s cubic-bezier(0.22,1,0.36,1) both; }
        .desc-card-entrance   { animation: descFadeUp  0.65s cubic-bezier(0.22,1,0.36,1) 0.12s both; }
        .desc-para            { animation: descParaIn  0.5s cubic-bezier(0.22,1,0.36,1) both; }
      `}</style>
    </section>
  );
}
