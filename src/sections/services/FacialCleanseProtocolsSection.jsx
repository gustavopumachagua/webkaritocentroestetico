    ...
    >
      <div className="relative overflow-hidden">
        <OptimizedImage
          src={item.imageSrc}
          alt={item.imageAlt}
          wrapperClassName="h-[11rem] w-full sm:h-[14rem] lg:h-[17rem]"
    ...
    <section className="relative overflow-hidden border-y border-white/5 bg-[#091019] py-24 sm:py-28 lg:py-32">
      ...
      <Container size="lg" className="relative z-10">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-[2.2rem] font-medium text-[var(--color-ink)] sm:text-[2.8rem] lg:text-[3.4rem] lg:leading-[1.05]">
