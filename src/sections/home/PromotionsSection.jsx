      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
          ...
          <div className="relative flex justify-end promo-image-entrance">
            <div
              aria-hidden
              className="absolute -right-3 -top-3 h-full w-full rounded-lg border border-[rgba(160,94,76,0.15)]"
            />
            <div className="group relative w-full max-w-md lg:max-w-lg">
              <div className="relative w-full overflow-hidden rounded-lg border border-white/8 shadow-[0_24px_64px_rgba(34,24,20,0.18)]">
                <OptimizedImage
                  src={imageAssets.promotions.generalPromociones}
                  alt={uiText.promotionsSection.imageAlt}
                  wrapperClassName="h-[320px] w-full sm:h-[420px] lg:h-[520px]"
                  className="h-full w-full object-cover object-[50%_45%] transition-transform duration-700 ease-out group-hover:scale-[1.06]"
                  fit="contain"
