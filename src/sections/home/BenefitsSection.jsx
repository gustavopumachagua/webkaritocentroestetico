...
function ChecklistItem({ item }) {
  return (
    <div className="flex items-start gap-3 border-b border-white/8 py-3 first:border-t">
      <div className="flex h-5 w-5 flex-shrink-0 items-center justify-center border-[1.5px] border-[var(--color-primary)]">
          ...
          <div className="order-1 lg:order-2">
            <div className="surface-panel overflow-hidden rounded-2xl">
              <OptimizedImage
                ...
                className="h-full w-full object-cover object-[50%_34%] transition duration-500 hover:scale-[1.02]"
                loading="lazy"
