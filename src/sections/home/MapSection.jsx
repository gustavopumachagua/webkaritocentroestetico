    ...
    <SectionShell id="ubicacion" tone="soft">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12">
          ...
          >
            <div className="overflow-hidden rounded-lg bg-[#091019] p-2 sm:p-3">
              <div className="group relative overflow-hidden rounded-lg">
                <div
                  aria-hidden
                  className={`optimized-image__skeleton absolute inset-0 z-10 transition-opacity duration-500 ${
