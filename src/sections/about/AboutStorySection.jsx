    ...
    <section className="relative overflow-hidden border-y border-white/5 bg-[#091019] py-20 sm:py-28 lg:py-32">
      ...
      <Container className="relative z-10">
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center lg:gap-24">
          <div>
            <h1 className="text-[2.45rem] font-semibold leading-[1.04] text-[var(--color-ink)] sm:text-[3.25rem] lg:text-[4rem]">
              {aboutPage.title}
            </h1>
          ...
          <div className="relative mx-auto w-full max-w-md lg:max-w-none">
            <div className="absolute -inset-3 rounded-lg border border-white/8 bg-[#0e1620]" />
            <div className="group relative overflow-hidden rounded-lg shadow-2xl shadow-black/10">
              <OptimizedImage
