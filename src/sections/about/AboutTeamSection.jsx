        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center lg:gap-20">
          <div className="order-2 mx-auto w-full max-w-sm lg:order-1 lg:max-w-none">
            <div className="group relative">
              <div className="absolute -bottom-4 -right-4 h-full w-full rounded-lg border border-white/8 bg-[#0d1620]" />
              <div className="relative overflow-hidden rounded-lg border border-white/8 bg-[#091019] shadow-[0_8px_40px_-8px_rgba(0,0,0,0.26)]">
                <OptimizedImage
                  src={teamSection.imageSrc}
                  alt={teamSection.imageAlt}
                  wrapperClassName="aspect-[4/5] w-full"
                  className="h-full w-full object-cover object-[50%_36%] transition duration-700 group-hover:scale-[1.03]"
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-[2.45rem] font-semibold leading-[1.04] text-[var(--color-ink)] sm:text-[3.1rem] lg:text-[3.8rem]">
              {teamSection.title}
            </h2>
