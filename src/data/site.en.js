...
export const headerNavigation = [
  ...
  { label: "About Us", href: "/nosotros" },
  {
    ...
    hash: "#servicios",
    submenu: [
      { label: "Aesthetic Medicine", href: "/medicina-estetica" },
...
export const hero = {
  autoplayMs: 5000,
  eyebrow: "Aesthetic medicine in Los Olivos",
  title: "Karito Aesthetic Center",
  description:
    "Facial treatments, body treatments, and aesthetic medicine with personalized evaluation, modern technology, and natural-looking results.",
  highlights: ["Personalized evaluation", "Private setting", "Visible results"],
  slides: [
    {
      id: "information",
...
export const services = [
  {
    ...
    description:
      "Aesthetic medical procedures to harmonize, refresh, and improve skin quality with natural-looking results.",
    detail:
      "Includes a prior evaluation to choose the most suitable protocol for your goals.",
...
export const promotionsIntro = {
  ...
  title:
    "Take advantage of exclusive discounts and packages on facial, body, and aesthetic treatments.",
...
export const promotions = [
  ...
  },
  {
    ...
    title: "Novuma",
    description:
      "A body-focused promotion created to work on contour, firmness, and overall skin appearance through a personalized plan.",
  },
  {
    id: "dermapen",
    eyebrow: "Promotions",
    title: "Dermapen",
    description:
      "A promotion to improve texture, pores, and skin quality through microneedling with professional evaluation.",
  },
  {
    id: "peeling",
    eyebrow: "Promotions",
    title: "Peeling",
    description:
      "A promotion focused on skin renewal for a brighter, more even, and fresher-looking complexion.",
  },
];
...
export const aestheticMedicinePage = {
  ...
  imageAlt: "Specialist preparing an aesthetic medicine procedure",
  imageLabel: "Aesthetic Medicine",
  cta: {
  ...
  tabs: [
    {
      ...
      label: "What is it?",
      paragraphs: [
        "<strong>Aesthetic medicine</strong> brings together non-surgical or minimally invasive procedures that help improve facial harmony, skin quality, and selected body goals after a professional evaluation.",
        "At <strong>Karito Aesthetic Center</strong>, every protocol is planned with a personalized approach so the result looks natural, safe, and aligned with your features, your skin, and the change you truly want.",
      ],
    },
    {
      id: "benefits",
      ...
      items: [
        {
          ...
          description:
            "The plan adapts to your features and avoids exaggerated changes.",
        },
        {
          title: "Personalized treatments:",
          description:
            "Every indication starts with an evaluation of the area, history, and goal.",
        },
        {
          title: "Progressive improvement:",
          description:
            "It can support rejuvenation, hydration, definition, or contouring with follow-up.",
        },
        {
          title: "Non-surgical procedures:",
          description:
            "Many options are performed in-office and allow you to return to your routine with simple care.",
        },
      ],
    },
  ],
  treatmentsSection: {
    title: "Aesthetic Medicine Services",
    description:
      "These treatments were previously spread across other sections. Now they are grouped together so you can choose the protocol that best matches your goal.",
  },
};
    ...
    items: [
      {
        ...
        description:
          "Body protocol designed to work on localized fat and improve contour in specific areas with evaluation and follow-up.",
        imageSrc: imageAssets.services.generalReductor,
        imageAlt: "Slimming body treatment",
        href: "/reductor",
      },
      {
        id: "hidrolipoclasia",
...
export const toxinaBotulinicaPage = {
  ...
  faqSection: {
    ...
    items: [
      ...
      {
        question: "Is recovery time needed?",
        answer:
          "No. Most people can continue their normal activities the same day.",
      },
      {
...
export const footer = {
  ...
  locations: [
    ...
    {
      label: "Coverage",
      value: "Aesthetic medicine, facial treatments, and body treatments.",
    },
  ],
