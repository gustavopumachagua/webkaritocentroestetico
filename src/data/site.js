...
export const site = {
  ...
  shortName: "Karito",
  brandMark: "Karito Centro Estético",
  brandName: "Karito Centro Estético",
  brandDescriptor: "Centro Estético",
  tagline: "Belleza consciente, resultados visibles y bienestar en cada cita.",
  footerDescription:
    "Una base profesional para una landing de centro estético: cercana, elegante y fácil de escalar con nuevas páginas, formularios o reservas online.",
};
...
export const headerNavigation = [
  ...
  { label: "Ubicación", href: "/", hash: "#ubicacion" },
];

export const hero = {
  autoplayMs: 5000,
  eyebrow: "Medicina estética en Los Olivos",
  title: "Karito Centro Estético",
  description:
    "Tratamientos faciales, corporales y medicina estética con evaluación personalizada, tecnología moderna y resultados naturales.",
  highlights: [
  ...
  slides: [
    {
      id: "informacion",
      imageSrc: imageAssets.services.heroInformacion.src,
      imageSources: imageAssets.services.heroInformacion.sources,
    ...
    {
      id: "servicios",
      imageSrc: imageAssets.services.heroServicios.src,
      imageSources: imageAssets.services.heroServicios.sources,
      primaryCta: { label: "Explorar", href: "#servicios" },
      secondaryCta: {
        label: "Contactar",
        href: "https://api.whatsapp.com/message/EZSTNTZEBGBAK1",
    ...
    {
      id: "promocion",
      imageSrc: imageAssets.services.heroPromocion.src,
      imageSources: imageAssets.services.heroPromocion.sources,
      primaryCta: { label: "Explorar", href: "#servicios" },
      secondaryCta: {
        label: "Contactar",
        href: "https://api.whatsapp.com/message/EZSTNTZEBGBAK1",
...
export const servicesIntro = {
  ...
  titleHighlight: "Medicina Estética, ",
...
export const services = [
  {
    ...
    description:
      "Procedimientos médicos estéticos para armonizar, rejuvenecer y mejorar calidad de piel con resultados naturales.",
    detail:
      "Incluye evaluación previa para elegir el protocolo más adecuado según tus objetivos.",
...
export const promotionsIntro = {
  ...
  title:
    "Aprovecha descuentos y paquetes exclusivos en tratamientos faciales, corporales y más.",
...
export const promotions = [
  ...
  },
  {
    ...
    title: "Dermapen",
    description:
      "Promoción para mejorar textura, poros y calidad de piel mediante microneedling con evaluación profesional.",
  },
  {
    id: "peeling",
    eyebrow: "Promociones",
    title: "Peeling",
    description:
      "Promoción enfocada en renovación cutánea para una piel más luminosa, uniforme y fresca.",
  },
];
...
export const faqs = [
  {
    ...
    answer:
      "Ofrecemos una amplia variedad de tratamientos faciales, tratamientos corporales, limpiezas faciales y promociones especiales, diseñados para adaptarse a diferentes necesidades estéticas y de bienestar.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Sí, recomendamos agendar con anticipación para asegurar tu horario ideal y prepararte una atención personalizada desde tu llegada al centro.",
  },
  {
...
export const whyChooseUs = {
  eyebrow: "Karito Centro Estético",
  title: "¿Por qué elegirnos?",
  lead: "Karito Centro Estético combina experiencia, atención cercana y rituales pensados para que cada visita se sienta especial.",
  description:
...
const mainLocationAddress = "Karito Centro Estético, Los Olivos, Lima, Perú";
...
export const aboutPage = {
  ...
  paragraphs: [
    "Bienvenidos a Karito Centro Estético, donde el bienestar se transforma en una experiencia única. En un ambiente de calma y cuidado, no solo ofrecemos tratamientos faciales y corporales de alta calidad, sino experiencias pensadas para realzar tu belleza y bienestar integral.",
    "Nuestro enfoque combina estética y armonía, invitándote a disfrutar de un momento de relajación y renovación. Con profesionales capacitados y espacios diseñados para tu comodidad, en Karito Centro Estético te ayudamos a sentirte y verte mejor. Elige cuidarte, elige verte bien, elige Karito Centro Estético.",
  ],
  imageSrc: imageAssets.about.nosotros,
  imageAlt: "Experiencia de bienestar en Karito Centro Estético",
  teamSection: {
    title: "Equipo Karito Centro Estético",
    ...
    imageAlt: "Especialista del equipo Karito Centro Estético",
  },
  purposeSection: {
    ...
    imageAlt: "Experiencia sensorial y de relajación en Karito Centro Estético",
  },
};

export const aestheticMedicinePage = {
  title: "Medicina Estética",
  imageSrc: imageAssets.services.queEsTratamientosFaciales,
  imageAlt: "Especialista preparando un procedimiento de medicina estética",
  imageLabel: "Medicina Estética",
  cta: {
  ...
  tabs: [
    {
      ...
      label: "¿Qué es?",
      paragraphs: [
        "La <strong>medicina estética</strong> reúne procedimientos no quirúrgicos o mínimamente invasivos que ayudan a mejorar la armonía facial, la calidad de la piel y algunos objetivos corporales con evaluación profesional previa.",
        "En <strong>Karito Centro Estético</strong> trabajamos cada protocolo con criterio personalizado para que el resultado se vea natural, seguro y alineado con tus facciones, tu piel y el cambio que realmente deseas.",
      ],
    },
    {
      id: "benefits",
      ...
      items: [
        {
          ...
          description:
            "El plan se adapta a tus rasgos y evita cambios exagerados.",
        },
        {
          title: "Tratamientos personalizados:",
          description:
            "Cada indicación parte de una evaluación de la zona, antecedentes y objetivo.",
        },
        {
          title: "Mejora progresiva:",
          description:
            "Permite trabajar rejuvenecimiento, hidratación, definición o contorno con seguimiento.",
        },
        {
          title: "Procedimientos sin cirugía:",
          description:
            "Muchas opciones se realizan en cabina y permiten retomar actividades con cuidados simples.",
        },
      ],
    },
  ],
  treatmentsSection: {
    title: "Servicios de Medicina Estética",
    description:
      "Estos tratamientos estaban repartidos entre otras secciones. Ahora los encuentras juntos para elegir con claridad el protocolo que mejor se alinea a tu objetivo.",
  },
};
  ...
  tabs: [
    {
      ...
      label: "¿Qué es?",
      paragraphs: [
        "Los <strong>tratamientos faciales</strong> son procedimientos diseñados para cuidar, prevenir y rejuvenecer la piel en cada etapa de la vida. A través de protocolos personalizados, es posible tratar necesidades como el acné, las manchas, la flacidez y los signos de envejecimiento prematuro.",
        "En <strong>Karito Centro Estético</strong> contamos con un portafolio integral realizado con productos profesionales y protocolos adaptados a cada tipo de piel, siempre con una evaluación previa para recomendarte la mejor opción.",
      ],
    },
    {
      id: "benefits",
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Suavizan la superficie, reducen la apariencia de los poros y mejoran la elasticidad.",
        },
        {
        ...
        },
        {
          ...
          description:
            "Con tecnologías específicas, ayuda a tensar la piel y combatir la flacidez.",
        },
      ],
    },
  ],
  treatmentsSection: {
    ...
    items: [
      ...
      },
      {
        ...
        imageAlt: "Aplicación de ácido hialurónico en el rostro",
  ...
  tabs: [
    {
      ...
      paragraphs: [
        ...
        "En <strong>Karito Centro Estético</strong> contamos con un portafolio completo de alternativas no invasivas y mínimamente invasivas, realizadas con equipos y productos aprobados por la FDA y bajo la supervisión de médicos.",
      ],
    },
    {
      id: "benefits",
    ...
    items: [
      {
        ...
        title: "Reductor",
        description:
          "Protocolo corporal orientado a trabajar grasa localizada y mejorar el contorno de zonas específicas con evaluación y seguimiento.",
        imageSrc: imageAssets.services.generalReductor,
        imageAlt: "Tratamiento corporal reductor",
        href: "/reductor",
      },
      {
        id: "hidrolipoclasia",
        ...
        description:
          "Tratamiento mínimamente invasivo que acompaña procesos de reducción localizada con valoración profesional.",
        imageSrc: imageAssets.services.generalHidrolipoclasia,
        imageAlt: "Tratamiento corporal de hidrolipoclasia",
      ...
      },
      {
        ...
        description:
          "Aplicación corporal enfocada en adiposidad localizada y apoyo de protocolos de modelado.",
        imageSrc: imageAssets.services.generalEnzimasPolvo,
        imageAlt: "Tratamiento corporal con enzimas en polvo",
        href: "/enzimas-polvo",
      },
    ],
  },
...
export const toxinaBotulinicaPage = {
    ...
    tabs: [
      {
        id: "what-is",
        label: "¿Qué es?",
        cardTitle: "¿Qué es el Botox y cómo funciona?",
        paragraphs: [
  ...
  benefitsDetailSection: {
    title: "Beneficios del Botox para Tu Piel",
    intro:
      "Los beneficios del Botox van más allá de la reducción de arrugas, proporcionando una serie de mejoras visibles y duraderas para el rostro:",
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Aunque los efectos del Botox no son permanentes, los resultados pueden durar entre 3 a 6 meses, lo que permite mantener una apariencia juvenil y fresca de forma continua.",
      },
    ],
  },
  procedureSection: {
  ...
  resultsSection: {
    ...
    resultsText:
      "Los resultados de la aplicación se evidencian durante los 9 a 11 días posteriores, teniendo su efecto máximo entre los 14 a 16 días.",
  ...
  faqSection: {
    ...
    items: [
      ...
      {
        question: "¿Se necesita tiempo de recuperación?",
        answer:
          "No. La mayoría de las personas puede continuar sus actividades normales el mismo día.",
      },
      {
  ...
  benefitsSection: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Al limpiar profundamente la piel, se fácilita la absorción de los productos de cuidado de la piel, maximizando sus beneficios.",
      },
      {
...
export const locationSection = {
  ...
  badge: "Google Maps",
  cardTitle: "Karito Centro Estético",
  iframeTitle: "Mapa de Karito Centro Estético",
  liveLabel: "En vivo",
...
export const contact = {
  ...
  address: mainLocationAddress,
  schedule: [
    "Lunes a Sábado de 10:00 a.m. a 7:30 p.m.",
...
export const footer = {
  companyName: "Karito Centro Estético",
  ...
  locations: [
    ...
    {
      label: "Cobertura",
      value: "Medicina estética, tratamientos faciales y corporales.",
    },
  ],
...
export function setSiteLocale(locale) {
  ...
  syncMutableValue(aestheticMedicinePage, nextData.aestheticMedicinePage);
