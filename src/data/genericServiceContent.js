    ...
    "aesthetic-medicine": [
      {
        question: `¿${service.title} requiere evaluación previa?`,
        answer:
          "Sí. En medicina estética la evaluación es indispensable para revisar antecedentes, zona a tratar, expectativas y confirmar si el procedimiento es adecuado para tu caso.",
      },
      {
        question: "¿Cuándo se empiezan a notar los resultados?",
        answer:
          "Depende del tratamiento. Algunos cambios pueden verse de forma temprana y otros evolucionan progresivamente durante días o semanas, por eso se explica el tiempo esperado durante la valoración.",
      },
      {
        question: "¿Qué cuidados debo seguir después?",
        answer:
          "Las indicaciones varían según el procedimiento, pero suelen incluir evitar manipular la zona, proteger la piel del sol y seguir las recomendaciones específicas entregadas al finalizar la cita.",
      },
    ],
    "body-treatment": [
      {
    ...
    "aesthetic-medicine": [
      {
        question: `Does ${service.title} require a prior evaluation?`,
        answer:
          "Yes. In aesthetic medicine, evaluation is essential to review your history, treatment area, expectations, and whether the procedure is appropriate for your case.",
      },
      {
        question: "When do results start to appear?",
        answer:
          "It depends on the treatment. Some changes may be visible early, while others evolve gradually over days or weeks, so expected timing is explained during the assessment.",
      },
      {
        question: "What aftercare should I follow?",
        answer:
          "Aftercare varies by procedure, but it often includes avoiding manipulation of the area, protecting the skin from sun exposure, and following the specific guidance provided after the appointment.",
      },
    ],
    "body-treatment": [
      {
...
function buildBeforeAfterContent(categoryId) {
  const beforeAfterByCategory = {
    "facial-cleanse": {
      beforeTitle: "Antes",
      beforeItems: [
        "Piel con impurezas, textura irregular o sensación de opacidad.",
        "Poros congestionados o acumulación de residuos por rutina, ambiente o maquillaje.",
      ],
      afterTitle: "Después",
      afterItems: [
        "Piel con sensación más limpia, fresca y confortable.",
        "Mejor luminosidad y una superficie más preparada para tu rutina de cuidado.",
      ],
    },
    "facial-treatment": {
      beforeTitle: "Antes",
      beforeItems: [
        "Textura, hidratación, firmeza o calidad de piel que necesitan un plan específico.",
        "Dudas sobre qué protocolo facial conviene según tu objetivo.",
      ],
      afterTitle: "Después",
      afterItems: [
        "Plan facial más claro, con objetivos y frecuencia definidos tras la evaluación.",
        "Mejora progresiva de apariencia, hidratación o textura según el tratamiento indicado.",
      ],
    },
    "aesthetic-medicine": {
      beforeTitle: "Antes",
      beforeItems: [
        "Líneas, falta de volumen, textura, flacidez localizada o una zona que deseas armonizar.",
        "Necesidad de una evaluación profesional para elegir una técnica segura y natural.",
      ],
      afterTitle: "Después",
      afterItems: [
        "Resultado más armónico y alineado a tu rostro, piel o zona corporal tratada.",
        "Evolución controlada con cuidados posteriores y seguimiento según el procedimiento.",
      ],
    },
    "body-treatment": {
      beforeTitle: "Antes",
      beforeItems: [
        "Zonas con retención, adiposidad localizada, flacidez o necesidad de modelado.",
        "Objetivos corporales que requieren orden, constancia y seguimiento.",
      ],
      afterTitle: "Después",
      afterItems: [
        "Proceso corporal mejor organizado y enfocado en la zona prioritaria.",
        "Mejor apariencia de contorno, firmeza o drenaje según el plan recomendado.",
      ],
    },
  };

  return beforeAfterByCategory[categoryId] ?? {
    beforeTitle: "Antes",
    beforeItems: [
      "Objetivo estético o necesidad específica pendiente de evaluación.",
      "Dudas sobre el protocolo más adecuado para tu caso.",
    ],
    afterTitle: "Después",
    afterItems: [
      "Plan personalizado con indicaciones claras.",
      "Seguimiento profesional para acompañar la evolución del tratamiento.",
    ],
  };
}

function buildBeforeAfterContentEn(categoryId) {
  const beforeAfterByCategory = {
    "facial-cleanse": {
      beforeTitle: "Before",
      beforeItems: [
        "Skin with impurities, uneven texture, or a dull appearance.",
        "Congested pores or residue buildup from routine, environment, or makeup.",
      ],
      afterTitle: "After",
      afterItems: [
        "Skin that feels cleaner, fresher, and more comfortable.",
        "Improved glow and a surface better prepared for your home-care routine.",
      ],
    },
    "facial-treatment": {
      beforeTitle: "Before",
      beforeItems: [
        "Texture, hydration, firmness, or skin quality that needs a specific plan.",
        "Uncertainty about which facial protocol best fits your goal.",
      ],
      afterTitle: "After",
      afterItems: [
        "A clearer facial plan with goals and frequency defined after evaluation.",
        "Progressive improvement in appearance, hydration, or texture according to the selected treatment.",
      ],
    },
    "aesthetic-medicine": {
      beforeTitle: "Before",
      beforeItems: [
        "Lines, volume loss, texture concerns, localized laxity, or an area you want to harmonize.",
        "Need for professional evaluation to choose a safe and natural-looking technique.",
      ],
      afterTitle: "After",
      afterItems: [
        "A more harmonious result aligned with your face, skin, or treated body area.",
        "Controlled evolution with aftercare and follow-up according to the procedure.",
      ],
    },
    "body-treatment": {
      beforeTitle: "Before",
      beforeItems: [
        "Areas with fluid retention, localized fat, laxity, or contouring needs.",
        "Body goals that require structure, consistency, and follow-up.",
      ],
      afterTitle: "After",
      afterItems: [
        "A better organized body process focused on the priority area.",
        "Improved appearance of contour, firmness, or drainage according to the recommended plan.",
      ],
    },
  };
  ...
  return beforeAfterByCategory[categoryId] ?? {
    beforeTitle: "Before",
    beforeItems: [
      "An aesthetic goal or specific need pending professional evaluation.",
      "Questions about the most appropriate protocol for your case.",
    ],
    afterTitle: "After",
    afterItems: [
      "A personalized plan with clear indications.",
      "Professional follow-up to support the treatment's evolution.",
    ],
  };
}
...
function getCategoryDefaults(service, category) {
  const defaultsByCategory = {
    "facial-cleanse": {
      ...
      usesItems: [
        "Retirar impurezas, células muertas y residuos acumulados.",
        "Mejorar la sensación de limpieza, frescura y luminosidad.",
        "Preparar la piel para absorber mejor la rutina de cuidado.",
        "Acompañar el mantenimiento facial de forma periódica.",
      ],
      ...
      beforeAfter: buildBeforeAfterContent(category?.id),
    },
    "facial-treatment": {
      ...
      usesTitle: "¿Para qué sirve?",
      usesItems: [
        "Mejorar calidad de piel, hidratación, textura o firmeza según evaluación.",
        "Acompañar objetivos de rejuvenecimiento o revitalización facial.",
        "Elegir una técnica acorde a tu necesidad y tolerancia cutánea.",
        "Construir un plan facial con seguimiento profesional.",
      ],
    ...
    "aesthetic-medicine": {
      tags: ["Evaluación estética", "Resultado natural", "Plan seguro"],
      heroNote:
        "Cada procedimiento se indica tras una evaluación para cuidar seguridad, naturalidad y armonía con tus rasgos o zona tratada.",
      overviewTitle: `${service.title}: medicina estética con enfoque personalizado`,
      overviewParagraphs: [
        `${service.title} forma parte de los procedimientos de medicina estética orientados a armonizar, rejuvenecer o mejorar la calidad de la piel y el contorno según la evaluación profesional.`,
        "La indicación se define revisando antecedentes, zona a tratar, expectativas y tiempos de evolución para recomendar un plan realista y seguro.",
      ],
      focusTitle: "Enfoque de trabajo",
      focusParagraph:
        "Priorizamos resultados naturales, técnica adecuada y seguimiento para que cada cambio tenga sentido con tu rostro, piel o zona corporal.",
      focusItems: [
        "Evaluar si el procedimiento es compatible con tu objetivo.",
        "Definir zonas, frecuencia y cuidados posteriores con claridad.",
        "Acompañar la evolución para mantener resultados armónicos.",
      ],
      benefitsTitle: "Beneficios que puede aportar",
      benefits: [
        {
          title: "Armonía y naturalidad",
          description:
            "Busca mejorar sin perder expresión, proporción ni autenticidad.",
        },
        {
          title: "Plan personalizado",
          description:
            "La indicación se ajusta a tu anatomía, piel y objetivo real.",
        },
        {
          title: "Seguimiento profesional",
          description:
            "Permite controlar evolución, cuidados y futuras sesiones si corresponde.",
        },
      ],
      idealTitle: "Ideal si buscas",
      idealItems: [
        "Mejorar una zona específica con criterio médico estético.",
        "Trabajar rejuvenecimiento, hidratación, definición o armonización.",
        "Recibir una recomendación segura antes de elegir un procedimiento.",
        "Lograr cambios sutiles, progresivos y alineados a tu evaluación.",
      ],
      usesTitle: "¿Para qué sirve?",
      usesItems: [
        "Armonizar rasgos, suavizar signos visibles o mejorar calidad cutánea.",
        "Aportar soporte, hidratación, definición o regeneración según el tratamiento.",
        "Trabajar zonas concretas con una técnica elegida tras evaluación.",
        "Diseñar un plan de mantenimiento o corrección con seguimiento.",
      ],
      protocolTitle: "Acerca del procedimiento",
      protocolSteps: [
        "Evaluación del objetivo, antecedentes y zona a tratar.",
        "Definición de técnica, cantidad de sesiones o pauta recomendada.",
        "Aplicación del procedimiento con monitoreo del confort y respuesta.",
        "Indicaciones posteriores y seguimiento según el tipo de tratamiento.",
      ],
      sessionTitle: "Evolución y seguimiento",
      sessionParagraphs: [
        "Los tiempos de resultado varían según el procedimiento: algunos se aprecian pronto y otros evolucionan progresivamente durante días o semanas.",
        "El seguimiento ayuda a revisar la respuesta, reforzar cuidados y decidir si conviene mantenimiento, retoque o combinación con otro protocolo.",
      ],
      faqTitle: "Preguntas frecuentes",
      beforeAfterTitle: "Antes y después",
      beforeAfter: buildBeforeAfterContent(category?.id),
    ...
    "body-treatment": {
      ...
      usesTitle: "¿Para qué sirve?",
      usesItems: [
        "Trabajar zonas corporales específicas con un protocolo ordenado.",
        "Acompañar objetivos de contorno, drenaje, modelado o firmeza.",
        "Definir una frecuencia realista según la respuesta del tejido.",
        "Complementar el proceso con seguimiento y recomendaciones posteriores.",
      ],
  ...
  return {
    ...
    usesTitle: "¿Para qué sirve?",
    usesItems: [
      "Definir un protocolo alineado a tu objetivo.",
      "Trabajar una necesidad estética con evaluación previa.",
      "Ordenar cuidados, frecuencia y seguimiento.",
      "Acompañar resultados de forma progresiva.",
    ],
...
function getCategoryDefaultsEn(service, category) {
  const defaultsByCategory = {
    "facial-cleanse": {
      ...
      usesItems: [
        "Remove impurities, dead skin cells, and accumulated residue.",
        "Improve the feeling of cleanliness, freshness, and glow.",
        "Prepare the skin to absorb your home-care routine more effectively.",
        "Support regular facial maintenance.",
      ],
      ...
      beforeAfter: buildBeforeAfterContentEn(category?.id),
    },
    "facial-treatment": {
      ...
      usesTitle: "What is it for?",
      usesItems: [
        "Improve skin quality, hydration, texture, or firmness according to evaluation.",
        "Support facial rejuvenation or revitalization goals.",
        "Choose a technique aligned with your need and skin tolerance.",
        "Build a facial plan with professional follow-up.",
      ],
    ...
    "aesthetic-medicine": {
      tags: ["Aesthetic evaluation", "Natural result", "Safe plan"],
      heroNote:
        "Each procedure is recommended after an evaluation to prioritize safety, natural-looking results, and harmony with your features or treated area.",
      overviewTitle: `${service.title}: aesthetic medicine with a personalized approach`,
      overviewParagraphs: [
        `${service.title} is part of aesthetic medicine procedures designed to harmonize, refresh, or improve skin quality and contour according to professional evaluation.`,
        "The indication is defined by reviewing your history, treatment area, expectations, and expected evolution time to recommend a realistic and safe plan.",
      ],
      focusTitle: "Our treatment approach",
      focusParagraph:
        "We prioritize natural-looking results, appropriate technique, and follow-up so every change makes sense with your face, skin, or body area.",
      focusItems: [
        "Evaluate whether the procedure matches your goal.",
        "Define areas, frequency, and aftercare clearly.",
        "Support the evolution to maintain harmonious results.",
      ],
      benefitsTitle: "Benefits it may provide",
      benefits: [
        {
          title: "Harmony and naturalness",
          description:
            "It aims to improve without losing expression, proportion, or authenticity.",
        },
        {
          title: "Personalized plan",
          description:
            "The indication adapts to your anatomy, skin, and real goal.",
        },
        {
          title: "Professional follow-up",
          description:
            "It helps monitor evolution, aftercare, and future sessions if needed.",
        },
      ],
      idealTitle: "Ideal if you want to",
      idealItems: [
        "Improve a specific area with aesthetic medical criteria.",
        "Work on rejuvenation, hydration, definition, or harmonization.",
        "Receive a safe recommendation before choosing a procedure.",
        "Achieve subtle, progressive changes aligned with your evaluation.",
      ],
      usesTitle: "What is it for?",
      usesItems: [
        "Harmonize features, soften visible signs, or improve skin quality.",
        "Provide support, hydration, definition, or regeneration according to the treatment.",
        "Work on specific areas with a technique chosen after evaluation.",
        "Design a maintenance or correction plan with follow-up.",
      ],
      protocolTitle: "About the procedure",
      protocolSteps: [
        "Evaluation of the goal, history, and area to be treated.",
        "Definition of technique, number of sessions, or recommended plan.",
        "Application of the procedure while monitoring comfort and response.",
        "Aftercare instructions and follow-up according to the type of treatment.",
      ],
      sessionTitle: "Evolution and follow-up",
      sessionParagraphs: [
        "Result timing varies depending on the procedure: some changes appear early, while others evolve gradually over days or weeks.",
        "Follow-up helps review the response, reinforce care, and decide whether maintenance, touch-up, or combination with another protocol is appropriate.",
      ],
      faqTitle: "Frequently asked questions",
      beforeAfterTitle: "Before and after",
      beforeAfter: buildBeforeAfterContentEn(category?.id),
    ...
    "body-treatment": {
      ...
      usesTitle: "What is it for?",
      usesItems: [
        "Work on specific body areas with an organized protocol.",
        "Support contouring, drainage, modeling, or firmness goals.",
        "Define a realistic frequency according to tissue response.",
        "Complement the process with follow-up and post-care recommendations.",
      ],
  ...
  return (
    defaultsByCategory[category?.id] ?? {
      ...
      usesTitle: "What is it for?",
      usesItems: [
        "Define a protocol aligned with your goal.",
        "Work on an aesthetic need after prior evaluation.",
        "Organize aftercare, frequency, and follow-up.",
        "Support results progressively.",
      ],
...
const serviceContentById = {
  "limpieza-facial-profunda": {
    tags: ["Limpieza intensiva", "Extracción segura", "Piel revitalizada"],
    heroNote:
      "Es ideal cuando la piel necesita una limpieza más completa, con extracción controlada y una pauta de cuidado posterior para recuperar frescura.",
    overviewTitle: "Limpieza facial profunda: purificación completa para renovar la piel",
    overviewParagraphs: [
      "La limpieza facial profunda trabaja impurezas, células muertas y exceso de sebo acumulado en los poros para dejar la piel con una sensación más limpia y equilibrada.",
      "Se diferencia de una limpieza básica porque permite adaptar exfoliación, extracción, calma e hidratación según el estado real de la piel en cabina.",
    ],
    focusParagraph:
      "Buscamos desobstruir poros, mejorar textura y devolver luminosidad sin agredir la barrera cutánea.",
    focusItems: [
      "Retirar comedones e impurezas de forma cuidadosa.",
      "Equilibrar la piel con productos adaptados al tipo de rostro.",
      "Cerrar con calma, hidratación y fotoprotección.",
    ],
    benefits: [
      {
        title: "Poros más limpios",
        description:
          "Ayuda a disminuir la congestión y la acumulación de grasa visible.",
      },
      {
        title: "Piel más fresca",
        description:
          "Deja una sensación de limpieza profunda y mejor luminosidad.",
      },
      {
        title: "Mejor rutina en casa",
        description:
          "Favorece que los productos posteriores se absorban de manera más uniforme.",
      },
    ],
    idealItems: [
      "Tienes puntos negros, textura irregular o piel opaca.",
      "Quieres una limpieza profesional más completa.",
      "Buscas preparar la piel antes de otro tratamiento.",
      "Necesitas mantenimiento facial periódico con evaluación.",
    ],
    protocolSteps: [
      "Evaluación del tipo de piel y nivel de congestión.",
      "Limpieza, exfoliación y preparación con vapor o técnica indicada.",
      "Extracción controlada y apoyo con activos calmantes.",
      "Mascarilla, hidratación, fotoprotección e indicaciones posteriores.",
    ],
    sessionParagraphs: [
      "Suele recomendarse como mantenimiento mensual o según la necesidad observada en la evaluación.",
      "Después de la sesión conviene hidratar, usar protector solar y evitar productos irritantes durante las primeras horas.",
    ],
    usesItems: [
      "Descongestionar poros y retirar impurezas acumuladas.",
      "Mejorar la textura, frescura y luminosidad del rostro.",
      "Preparar la piel para responder mejor a tu rutina de cuidado.",
      "Ordenar un mantenimiento facial personalizado según evaluación.",
    ],
    beforeAfter: {
      beforeTitle: "Antes",
      beforeItems: [
        "Piel opaca, con textura irregular, puntos negros o sensación de congestión.",
        "Poros con exceso de sebo o residuos acumulados por maquillaje, ambiente o rutina diaria.",
      ],
      afterTitle: "Después",
      afterItems: [
        "Piel con sensación más limpia, fresca y confortable.",
        "Mejor luminosidad y superficie más preparada para hidratación y cuidados posteriores.",
      ],
    },
    faq: [
      {
        ...
        answer:
          "La extracción puede generar una molestia leve en zonas congestionadas, pero el protocolo se adapta a la sensibilidad de la piel para mantener una experiencia tolerable y segura.",
      },
      {
        question: "¿Cada cuánto se recomienda realizarla?",
        answer:
          "En muchos casos se sugiere una frecuencia mensual, aunque la indicación final depende del tipo de piel, nivel de congestión y objetivos definidos en evaluación.",
      },
      {
        question: "¿Puedo maquillarme después?",
        answer:
          "Lo ideal es dejar descansar la piel durante las primeras horas, hidratarla y usar protector solar. Si necesitas maquillarte, se recomienda seguir la indicación profesional recibida al finalizar.",
      },
    ],
  },
  dermaplaning: {
    tags: ["Exfoliación suave", "Piel luminosa", "Textura uniforme"],
    heroNote:
      "Es una opción cómoda para retirar células muertas y vello fino, logrando una piel más lisa y preparada para hidratarse mejor.",
    overviewTitle: "Dermaplaning: exfoliación precisa para una piel más suave",
    overviewParagraphs: [
      "Dermaplaning es una técnica de exfoliación mecánica suave que retira células muertas y vello facial fino para mejorar la textura y el acabado de la piel.",
      "Se realiza con evaluación previa para confirmar sensibilidad, estado de la barrera cutánea y si conviene combinarlo con hidratación u otro protocolo facial.",
    ],
    focusParagraph:
      "La prioridad es lograr suavidad y luminosidad sin irritar la piel, respetando el tipo de rostro y sus necesidades.",
    focusItems: [
      "Retirar células muertas superficiales de forma controlada.",
      "Mejorar la apariencia de textura y luminosidad.",
      "Preparar la piel para recibir hidratación o activos posteriores.",
    ],
    benefits: [
      {
        title: "Acabado más liso",
        description:
          "La piel puede sentirse más suave y con una textura más pareja.",
      },
      {
        title: "Más luminosidad",
        description:
          "Al retirar acumulación superficial, el rostro suele verse más fresco.",
      },
      {
        title: "Mejor absorción",
        description:
          "Puede favorecer una aplicación más uniforme de hidratantes y sueros.",
      },
    ],
    idealItems: [
      "Buscas una exfoliación suave y sin químicos intensos.",
      "Notas textura apagada o piel áspera.",
      "Quieres preparar tu piel antes de un evento.",
      "Deseas mejorar el acabado del maquillaje y la rutina facial.",
    ],
    protocolSteps: [
      "Limpieza y revisión del estado de la piel.",
      "Exfoliación controlada con técnica dermaplaning.",
      "Aplicación de activos calmantes o hidratantes según necesidad.",
      "Cierre con protección y recomendaciones de cuidado.",
    ],
    sessionParagraphs: [
      "La frecuencia se define según sensibilidad y objetivo; puede integrarse como mantenimiento facial periódico.",
      "Después se recomienda fotoprotección y evitar exfoliantes o activos irritantes por el tiempo indicado.",
    ],
  },
  hidrafacial: {
  ...
  "depilacion-cera": {
    tags: ["Piel suave", "Retiro desde la raíz", "Acabado prolijo"],
    heroNote:
      "Es una alternativa práctica para retirar el vello desde la raíz y mantener la piel con un acabado más limpio por más tiempo.",
    overviewTitle: "Depilación con cera: suavidad y acabado prolijo",
    overviewParagraphs: [
      "La depilación con cera retira el vello desde la raíz para lograr una piel más suave y un resultado de mayor duración frente al rasurado.",
      "El protocolo se adapta a la zona, sensibilidad y condición de la piel para reducir molestias y cuidar el acabado posterior.",
    ],
    focusParagraph:
      "Buscamos una depilación ordenada, higiénica y cómoda, cuidando la piel antes y después del retiro del vello.",
    focusItems: [
      "Preparar la zona para una adherencia adecuada de la cera.",
      "Retirar el vello de forma controlada y por secciones.",
      "Calmar la piel y dar indicaciones para evitar irritación.",
    ],
    benefits: [
      {
        title: "Resultado más duradero",
        description:
          "Al retirar el vello desde la raíz, la piel permanece suave por más tiempo.",
      },
      {
        title: "Acabado limpio",
        description:
          "Ayuda a mantener una apariencia prolija en la zona tratada.",
      },
      {
        title: "Mantenimiento práctico",
        description:
          "Puede organizarse de forma periódica según crecimiento y sensibilidad.",
      },
    ],
    idealItems: [
      "Quieres retirar vello con un resultado más duradero.",
      "Buscas una piel suave y prolija.",
      "Prefieres un servicio profesional para zonas sensibles.",
      "Deseas mantener una rutina de depilación ordenada.",
    ],
    protocolSteps: [
      "Evaluación breve de la zona y preparación de la piel.",
      "Aplicación de cera con temperatura y técnica adecuadas.",
      "Retiro del vello por secciones cuidando la sensibilidad.",
      "Cierre con producto calmante y recomendaciones posteriores.",
    ],
    sessionParagraphs: [
      "La frecuencia depende del crecimiento del vello y de la zona tratada.",
      "Después se recomienda evitar calor intenso, fricción y exfoliación fuerte durante las primeras horas.",
    ],
  },
  pqage: {
  ...
  "eliminacion-verrugas": {
    tags: ["Procedimiento localizado", "Evaluación previa", "Cuidado de piel"],
    heroNote:
      "Se realiza únicamente después de valorar la lesión, la zona y los cuidados necesarios para retirar verrugas de forma profesional.",
    overviewTitle: "Eliminación de verrugas: retiro localizado con evaluación profesional",
    overviewParagraphs: [
      "La eliminación de verrugas es un procedimiento localizado que busca retirar lesiones benignas visibles cuando la evaluación confirma que pueden tratarse en cabina estética o con derivación si corresponde.",
      "Antes de iniciar se revisa tamaño, ubicación, tiempo de evolución, sensibilidad y antecedentes para elegir una técnica prudente y dar indicaciones claras de cuidado posterior.",
    ],
    focusParagraph:
      "La prioridad es cuidar la piel alrededor de la zona, trabajar con técnica localizada y acompañar la recuperación con indicaciones precisas.",
    focusItems: [
      "Evaluar si la lesión es apta para retiro estético.",
      "Trabajar de forma localizada respetando la zona circundante.",
      "Indicar cuidados posteriores para favorecer una buena evolución.",
    ],
    benefits: [
      {
        title: "Trabajo preciso",
        description:
          "Se enfoca en la verruga y en la protección de la piel cercana.",
      },
      {
        title: "Mejor apariencia",
        description:
          "Ayuda a tratar lesiones visibles que generan incomodidad estética.",
      },
      {
        title: "Seguimiento claro",
        description:
          "Incluye recomendaciones para cuidar la zona durante la recuperación.",
      },
    ],
    idealItems: [
      "Tienes una verruga visible que deseas evaluar.",
      "Buscas retiro localizado con técnica profesional.",
      "Necesitas saber si la lesión puede tratarse o requiere derivación.",
      "Quieres indicaciones claras para cuidar la zona después.",
    ],
    protocolSteps: [
      "Evaluación visual y revisión de antecedentes relevantes.",
      "Confirmación de la técnica indicada o recomendación de derivación si aplica.",
      "Retiro localizado con control de la zona tratada.",
      "Cuidado final, indicaciones posteriores y pauta de seguimiento.",
    ],
    sessionParagraphs: [
      "La cantidad de sesiones depende del tipo, tamaño y ubicación de la verruga, así como de la respuesta de la piel.",
      "Después del procedimiento se deben seguir las indicaciones de limpieza, protección y evitar manipulación de la zona.",
    ],
  },
  reductor: {
    tags: ["Grasa localizada", "Contorno corporal", "Plan progresivo"],
    heroNote:
      "Se recomienda cuando buscas trabajar zonas específicas con un protocolo corporal organizado y seguimiento de evolución.",
    overviewTitle: "Reductor: protocolo corporal para trabajar contorno y grasa localizada",
    overviewParagraphs: [
      "El tratamiento reductor se orienta a trabajar adiposidad localizada y mejorar el contorno de zonas específicas mediante un plan corporal personalizado.",
      "No reemplaza hábitos saludables, pero puede acompañar objetivos de modelado cuando se organiza con evaluación, constancia y recomendaciones posteriores.",
    ],
    focusParagraph:
      "Buscamos definir una zona prioritaria, ordenar frecuencia de sesiones y acompañar el proceso con seguimiento realista.",
    focusItems: [
      "Trabajar grasa localizada en abdomen, muslos u otras zonas evaluadas.",
      "Acompañar modelado corporal con una pauta de sesiones.",
      "Revisar evolución y ajustar el plan según respuesta del tejido.",
    ],
    benefits: [
      {
        title: "Trabajo localizado",
        description:
          "Permite enfocar el protocolo en zonas concretas definidas en evaluación.",
      },
      {
        title: "Contorno más definido",
        description:
          "Puede acompañar una mejor apariencia corporal de forma progresiva.",
      },
      {
        title: "Plan con seguimiento",
        description:
          "La continuidad permite medir avances y ajustar la estrategia.",
      },
    ],
    idealItems: [
      "Buscas trabajar grasa localizada en una zona específica.",
      "Quieres complementar hábitos con un protocolo corporal.",
      "Deseas un plan de varias sesiones con evaluación.",
      "Necesitas seguimiento para revisar avances y continuidad.",
    ],
    protocolSteps: [
      "Evaluación de zona, objetivo corporal y antecedentes relevantes.",
      "Preparación del tejido y elección de la técnica reductora indicada.",
      "Aplicación del protocolo con control de confort y respuesta.",
      "Recomendaciones posteriores y planificación de próximas sesiones.",
    ],
    sessionParagraphs: [
      "El número de sesiones depende de la zona, objetivo y respuesta observada. En muchos casos se recomienda un plan progresivo.",
      "La hidratación, movimiento y hábitos saludables ayudan a acompañar mejor los resultados.",
    ],
    usesItems: [
      "Trabajar adiposidad localizada en abdomen, muslos, cintura u otras zonas evaluadas.",
      "Acompañar objetivos de modelado y mejora del contorno corporal.",
      "Estimular un proceso progresivo con sesiones organizadas y seguimiento.",
      "Complementar hábitos saludables con un protocolo corporal dirigido.",
    ],
    beforeAfter: {
      beforeTitle: "Antes",
      beforeItems: [
        "Zonas con grasa localizada, retención o contorno que deseas trabajar de forma dirigida.",
        "Necesidad de ordenar frecuencia, expectativas y hábitos que acompañen el proceso.",
      ],
      afterTitle: "Después",
      afterItems: [
        "Plan corporal más claro, enfocado en la zona prioritaria y con seguimiento.",
        "Mejor apariencia de contorno y tejido cuando existe constancia y respuesta favorable.",
      ],
    },
    faq: [
      {
        question: "¿El tratamiento reductor reemplaza dieta o ejercicio?",
        answer:
          "No. Es un apoyo estético para trabajar zonas específicas, pero se acompaña mejor con hidratación, movimiento y hábitos saludables.",
      },
      {
        question: "¿Cuántas sesiones necesito?",
        answer:
          "Depende de la zona, objetivo y respuesta del tejido. En evaluación se recomienda una pauta progresiva y se ajusta según evolución.",
      },
      {
        question: "¿Se puede trabajar más de una zona?",
        answer:
          "Sí, siempre que la evaluación lo indique. Se prioriza una estrategia ordenada para cuidar tiempos, intensidad y seguimiento.",
      },
    ],
  },
  "drenaje-post-lipo": {
  ...
  "pink-intimate": {
    tags: ["Cuidado íntimo", "Tono uniforme", "Zona sensible"],
    heroNote:
      "Se plantea como un protocolo delicado y personalizado para zonas íntimas o sensibles cuando se busca mejorar el aspecto del tono y la luminosidad de forma gradual.",
    overviewTitle: "Pink Intimate: cuidado estético para zonas íntimas sensibles",
    overviewParagraphs: [
      "Pink Intimate es un protocolo estético orientado a acompañar el cuidado visual de zonas íntimas o sensibles, especialmente cuando se busca mejorar la apariencia del tono y aportar una sensación de piel más cuidada.",
      "La indicación se define siempre con evaluación previa, respetando la sensibilidad de la zona, antecedentes, hábitos y expectativas realistas para elegir el enfoque más adecuado.",
    ],
    focusParagraph:
      "La prioridad es trabajar con delicadeza, privacidad y una pauta profesional que cuide la piel mientras acompaña objetivos de uniformidad y luminosidad.",
    focusItems: [
      "Evaluar la zona y descartar irritación o sensibilidad activa antes de iniciar.",
      "Definir un protocolo gradual acorde al tipo de piel y objetivo.",
      "Acompañar el proceso con cuidados posteriores claros y seguimiento.",
    ],
    benefits: [
      {
        title: "Tono más uniforme",
        description:
          "Puede ayudar a mejorar visualmente la uniformidad del tono en la zona tratada.",
      },
      {
        title: "Cuidado personalizado",
        description:
          "Se adapta a la sensibilidad, hábitos y respuesta de cada persona.",
      },
      {
        title: "Proceso progresivo",
        description:
          "Permite trabajar con una pauta ordenada y expectativas realistas.",
      },
    ],
    idealItems: [
      "Buscas mejorar el aspecto del tono en una zona íntima o sensible.",
      "Quieres un protocolo discreto, cuidadoso y con evaluación previa.",
      "Notas pigmentación irregular y deseas orientación profesional.",
      "Prefieres trabajar el objetivo de forma gradual y acompañada.",
    ],
    protocolSteps: [
      "Evaluación privada de la zona, antecedentes y sensibilidad actual.",
      "Preparación suave de la piel según tolerancia.",
      "Aplicación del protocolo indicado con control del confort.",
      "Cierre con recomendaciones posteriores y pauta de continuidad.",
    ],
    sessionParagraphs: [
      "La frecuencia depende del estado de la piel, de la sensibilidad de la zona y del objetivo planteado durante la evaluación.",
      "Después de la sesión suelen recomendarse cuidados suaves, evitar fricción intensa y seguir las indicaciones profesionales para acompañar mejor el resultado.",
    ],
  },
  "papada-enzimas": {
...
const serviceContentByIdEn = {
  "limpieza-facial-profunda": {
    tags: ["Intensive cleanse", "Safe extraction", "Refreshed skin"],
    heroNote:
      "Ideal when the skin needs a more complete cleanse, controlled extraction, and clear aftercare to recover freshness and comfort.",
    overviewTitle:
      "Deep Facial Cleanse: complete purification to refresh the skin",
    overviewParagraphs: [
      "A deep facial cleanse works on impurities, dead skin cells, and excess sebum accumulated in the pores to leave the skin feeling cleaner and more balanced.",
      "It goes beyond a basic cleanse by adapting exfoliation, extraction, soothing care, and hydration according to the real condition of the skin during the session.",
    ],
    focusParagraph:
      "We aim to unclog pores, improve texture, and restore glow without disrupting the skin barrier.",
    focusItems: [
      "Remove blackheads and impurities with a careful technique.",
      "Balance the skin with products adapted to each face.",
      "Finish with soothing care, hydration, and sun protection guidance.",
    ],
    benefitsTitle: "Benefits of a deep facial cleanse",
    benefits: [
      {
        title: "Cleaner pores",
        description:
          "Helps reduce visible congestion and accumulated oil in the skin.",
      },
      {
        title: "Fresher-looking skin",
        description:
          "Leaves a deep-clean feeling and supports a brighter appearance.",
      },
      {
        title: "Better home-care routine",
        description:
          "Allows following products to absorb and apply more evenly.",
      },
    ],
    idealItems: [
      "You have blackheads, uneven texture, or dull-looking skin.",
      "You want a more complete professional cleanse.",
      "You are preparing your skin before another treatment.",
      "You need periodic facial maintenance with evaluation.",
    ],
    usesItems: [
      "Unclog pores and remove accumulated impurities.",
      "Improve skin texture, freshness, and glow.",
      "Prepare the skin to respond better to home care.",
      "Create a personalized facial maintenance plan.",
    ],
    protocolTitle: "How the procedure is performed",
    protocolSteps: [
      "Evaluation of skin type and congestion level.",
      "Cleansing, exfoliation, and preparation with steam or the indicated technique.",
      "Controlled extraction supported with soothing active ingredients.",
      "Mask, hydration, sun protection, and aftercare guidance.",
    ],
    sessionTitle: "Frequency and aftercare",
    sessionParagraphs: [
      "It is often recommended monthly or according to the need observed during evaluation.",
      "After the session, hydration, sunscreen, and avoiding irritating products during the first hours are usually recommended.",
    ],
    beforeAfter: {
      beforeTitle: "Before",
      beforeItems: [
        "Dull skin with uneven texture, blackheads, or a congested feeling.",
        "Pores with excess sebum or buildup from makeup, environment, or daily routine.",
      ],
      afterTitle: "After",
      afterItems: [
        "Skin that feels cleaner, fresher, and more comfortable.",
        "Improved glow and a surface better prepared for hydration and aftercare.",
      ],
    },
    faq: [
      {
        question: "Does a deep facial cleanse hurt?",
        answer:
          "Extraction may cause mild discomfort in congested areas, but the protocol is adapted to skin sensitivity to keep the session tolerable and safe.",
      },
      {
        question: "How often is it recommended?",
        answer:
          "In many cases it is suggested monthly, although the final recommendation depends on skin type, congestion level, and goals defined during evaluation.",
      },
      {
        question: "Can I wear makeup afterward?",
        answer:
          "Ideally, the skin should rest for the first hours with hydration and sunscreen. If you need makeup, follow the professional guidance provided after the session.",
      },
    ],
  },
  reductor: {
    tags: ["Localized fat", "Body contour", "Progressive plan"],
    heroNote:
      "Recommended when you want to work on specific areas through an organized body protocol and progress follow-up.",
    overviewTitle:
      "Slimming Treatment: a body protocol for contour and localized fat",
    overviewParagraphs: [
      "The slimming treatment focuses on localized fat and body contour improvement in specific areas through a personalized body plan.",
      "It does not replace healthy habits, but it can support contouring goals when organized with evaluation, consistency, and aftercare guidance.",
    ],
    focusParagraph:
      "We define the priority area, organize session frequency, and support the process with realistic follow-up.",
    focusItems: [
      "Work on localized fat in the abdomen, thighs, or other evaluated areas.",
      "Support body contouring through a structured session plan.",
      "Review progress and adjust the plan according to tissue response.",
    ],
    benefitsTitle: "Benefits of the slimming protocol",
    benefits: [
      {
        title: "Localized work",
        description:
          "Allows the protocol to focus on specific areas defined during evaluation.",
      },
      {
        title: "More defined contour",
        description:
          "May support a better body appearance in a progressive way.",
      },
      {
        title: "Plan with follow-up",
        description:
          "Consistency helps track progress and adjust the strategy over time.",
      },
    ],
    idealItems: [
      "You want to work on localized fat in a specific area.",
      "You want to complement habits with a body protocol.",
      "You prefer a multi-session plan with evaluation.",
      "You need follow-up to review progress and continuity.",
    ],
    usesItems: [
      "Work on localized fat in the abdomen, thighs, waist, or other evaluated areas.",
      "Support body contouring and silhouette improvement goals.",
      "Stimulate a progressive process with organized sessions and follow-up.",
      "Complement healthy habits with a targeted body protocol.",
    ],
    protocolTitle: "How the procedure is organized",
    protocolSteps: [
      "Evaluation of the area, body goal, and relevant history.",
      "Tissue preparation and selection of the indicated slimming technique.",
      "Application of the protocol while monitoring comfort and response.",
      "Aftercare recommendations and planning of upcoming sessions.",
    ],
    sessionTitle: "Sessions and process support",
    sessionParagraphs: [
      "The number of sessions depends on the area, goal, and observed response. A progressive plan is often recommended.",
      "Hydration, movement, and healthy habits help support the results more effectively.",
    ],
    beforeAfter: {
      beforeTitle: "Before",
      beforeItems: [
        "Areas with localized fat, retention, or contour concerns you want to work on.",
        "Need to organize frequency, expectations, and habits that support the process.",
      ],
      afterTitle: "After",
      afterItems: [
        "A clearer body plan focused on the priority area with follow-up.",
        "Improved contour and tissue appearance when there is consistency and favorable response.",
      ],
    },
    faq: [
      {
        question: "Does the slimming treatment replace diet or exercise?",
        answer:
          "No. It is an aesthetic support for specific areas and works best with hydration, movement, and healthy habits.",
      },
      {
        question: "How many sessions do I need?",
        answer:
          "It depends on the area, goal, and tissue response. During evaluation, a progressive plan is recommended and adjusted according to progress.",
      },
      {
        question: "Can more than one area be treated?",
        answer:
          "Yes, when evaluation indicates it. The strategy is organized to respect timing, intensity, and follow-up.",
      },
    ],
  },
  "pink-intimate": {
    tags: ["Intimate care", "Even-looking tone", "Sensitive area"],
    heroNote:
      "This is planned as a delicate, personalized protocol for intimate or sensitive areas when the goal is to improve the appearance of tone and brightness gradually.",
    overviewTitle: "Pink Intimate: aesthetic care for sensitive intimate areas",
    overviewParagraphs: [
      "Pink Intimate is an aesthetic protocol designed to support the visual care of intimate or sensitive areas, especially when the goal is a more even-looking tone and a cared-for skin appearance.",
      "The recommendation is always defined through prior evaluation, respecting sensitivity, history, habits, and realistic expectations to choose the most appropriate approach.",
    ],
    focusParagraph:
      "The priority is to work gently, privately, and with professional guidance that cares for the skin while supporting tone uniformity and brightness goals.",
    focusItems: [
      "Evaluate the area and rule out active irritation or sensitivity before starting.",
      "Define a gradual protocol according to skin type and goal.",
      "Support the process with clear aftercare and follow-up.",
    ],
    benefits: [
      {
        title: "More even-looking tone",
        description:
          "It may help visually improve tone uniformity in the treated area.",
      },
      {
        title: "Personalized care",
        description:
          "The protocol adapts to sensitivity, habits, and each person's response.",
      },
      {
        title: "Progressive process",
        description:
          "It allows the goal to be approached with an organized plan and realistic expectations.",
      },
    ],
    idealItems: [
      "You want to improve the appearance of tone in an intimate or sensitive area.",
      "You prefer a discreet, careful protocol with prior evaluation.",
      "You notice uneven pigmentation and want professional guidance.",
      "You would rather work on the goal gradually with follow-up.",
    ],
    protocolSteps: [
      "Private evaluation of the area, history, and current sensitivity.",
      "Gentle skin preparation according to tolerance.",
      "Application of the indicated protocol while monitoring comfort.",
      "Finishing care with aftercare guidance and a continuity plan.",
    ],
    sessionParagraphs: [
      "Frequency depends on the skin condition, the area's sensitivity, and the goal defined during evaluation.",
      "After the session, gentle care, avoiding intense friction, and following professional guidance are usually recommended to better support the result.",
    ],
  },
};
...
export function getGenericServiceContent(service, category) {
  if (currentLocale === "en") {
    ...
    const specific = serviceContentByIdEn[service.id] ?? {};
    const merged = {
      ...defaults,
      ...specific,
      usesItems:
        ...
        defaults.idealItems,
      beforeAfter:
        specific.beforeAfter ??
        defaults.beforeAfter ??
        buildBeforeAfterContentEn(category?.id),
    };

    return {
      ...merged,
      faq: specific.faq ?? buildFaqEn(service, category?.id),
    };
  }
  ...
  return {
    ...merged,
    usesItems: specific.usesItems ?? merged.usesItems ?? merged.idealItems,
    beforeAfter:
      specific.beforeAfter ??
      merged.beforeAfter ??
      buildBeforeAfterContent(category?.id),
