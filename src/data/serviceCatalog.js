...
const serviceCategories = {
  ...
  "facial-treatment": {
    ...
    relatedIds: ["prp-capilar", "plasma-capilar", "hidralips", "peptona"],
  },
  "body-treatment": {
    id: "body-treatment",
    ...
    relatedIds: ["hidrolipoclasia", "papada-enzimas", "tonegirl", "musc-forte"],
  },
};
...
const serviceDefinitions = [
  ...
  },
  {
    ...
    href: "/eliminacion_verrugas",
    categoryId: "aesthetic-medicine",
    description:
      "Procedimiento localizado para valorar y retirar verrugas estéticas con técnica profesional y cuidados posteriores.",
    imageSrc: imageAssets.services.generalEliminacionVerruga,
  },
  {
  ...
  },
  {
    ...
    categoryId: "body-treatment",
    description:
      "Protocolo íntimo orientado a mejorar el aspecto del tono y la luminosidad de zonas sensibles con evaluación y cuidados personalizados.",
    imageSrc: imageAssets.services.generalPinkIntimate,
  },
  {
    id: "papada-enzimas",
...
const serviceTextByLocale = {
  en: {
    ...
    "pink-intimate": {
      title: "Pink Intimate",
      description:
        "Intimate-area protocol focused on improving the appearance of tone and brightness in sensitive zones with personalized evaluation and care.",
    },
    "papada-enzimas": {
    ...
    "eliminacion-verrugas": {
      title: "Wart Removal",
      description:
        "Localized procedure to assess and remove aesthetic warts with professional technique and aftercare guidance.",
    },
  },
};
...
export function getRelatedServicesForService(serviceId, limit = Infinity) {
