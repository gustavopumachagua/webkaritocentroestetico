  ...
  return (
    <div className="fixed inset-0 z-[120] px-4 py-6 sm:px-6 sm:py-8">
      ...
      <div
        ...
        className="relative mx-auto flex max-h-[92vh] w-full max-w-6xl flex-col overflow-hidden rounded-lg border border-white/10 bg-[#081019] shadow-[0_32px_120px_rgba(0,0,0,0.45)]"
      >
        ...
        <div className="overflow-y-auto px-5 py-5 sm:px-7 sm:py-7">
          <div className="grid gap-7 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
            <figure className="group relative w-full overflow-hidden rounded-lg border border-white/8 shadow-[0_24px_70px_rgba(0,0,0,0.28)]">
              <OptimizedImage
                src={image}
                alt={promotion.title}
                wrapperClassName="h-[17rem] w-full sm:h-[20rem] lg:h-[23rem] xl:h-[25rem]"
          ...
          <div className="mt-10">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h3 className="mt-4 text-[2.2rem] font-medium text-[var(--color-ink)] sm:text-[2.8rem]">
