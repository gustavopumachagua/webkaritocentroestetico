  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/8 bg-[linear-gradient(180deg,#070b10_0%,#0b1016_100%)]">
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(207,155,114,0.08)_0%,transparent_42%,rgba(99,125,156,0.07)_100%)]" />
      </div>
        ...
        <div className="grid gap-10 xl:grid-cols-[1.55fr_1fr_1fr_1fr]">
          <div className="space-y-5">
            <div>
              ...
              <h2 className="mt-3 text-[2.35rem] font-medium text-[var(--color-ink)] sm:text-[2.8rem]">
                {footer.companyName}
              </h2>
            </div>
