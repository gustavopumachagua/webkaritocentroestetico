...
export default function RelatedServiceCard({ title, image, href = "#" }) {
  return (
    <a
      href={href}
      className="related-card group relative block overflow-hidden rounded-lg border border-white/8"
    >
      <div className="relative overflow-hidden">
        <OptimizedImage
          src={image}
          alt={title}
          wrapperClassName="aspect-[6/5] w-full sm:aspect-[3/4]"
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 rounded-lg ring-1 ring-white/6 transition-all duration-300 group-hover:ring-[rgba(160,94,76,0.38)]"
      />
